...
from src.langgraphagentical.tools.search_tool import get_tools, create_tool_node
from langgraph.prebuilt import tools_condition, ToolNode
from src.langgraphagentical.nodes.chatbot_with_Tool_nose import ChatbotWithToolNode
from src.langgraphagentical.nodes.ai_news_node import AI_News_Node


class GraphBuilder:
    def __init__(self):
        self.graph_buider = Graph()
    ...
    def ai_news_builder_graph(self):
        ...
        self.graph_buider.set_exit_point("save_results", END)
